...
class LeadController extends Controller
{
    ...
    public function index(){
        return view('admin.lead.leadEntry');
    }


    public function save(Request $request){
        $LoanEntry = new Lead();
        $LoanEntry -> phone = $request->phone;
        $LoanEntry -> name = $request->name;

        $LoanEntry -> amount = $request ->amount;
        $LoanEntry -> fb = $request ->fb;
        $LoanEntry -> last_action = $request ->last_action;
        $LoanEntry -> next_action = $request ->next_action;
        $LoanEntry -> prob = $request ->prob;
        $LoanEntry -> score = $request ->score;
        $LoanEntry -> fb_url = $request ->fb_url;
        $LoanEntry -> email = $request ->email;
        $LoanEntry -> note = $request ->note;
        $LoanEntry -> staff = Auth::user()->name;
        $LoanEntry -> save();

       return redirect('/leads/manage')->with('message','Амжилттай');
    }
    ...
    public function manage(){
        $loan = Lead::all();
        return view('admin.lead.leadManage', ['loan'=>$loan]);
    }
    ...
    public function delete($id){
        ...
        return redirect('/leads/manage')->with('message','deleted');
    }
