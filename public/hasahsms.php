...
ini_set("allow_url_fopen", 1);
  ...
  $text='Tanii gereenii dugaar: '.$customer->number.' Ta '.$hasalt.' dungeer zeeleesee hasalt hiih bol ' .$payid. ' holboos deer darna uu.';
...
if (isset($_GET["phone"])) {
    ...
    $db->insert(DB_NAME, TBL_NAME, $col_val);
       ...
       print_r('{ "messages": [   {"text": "'.'Та эхлээд 30 хоногийн төлөлтөө хийнэ үү.'.'"} ]}');   
}
 }
