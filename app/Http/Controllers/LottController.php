...
class LottController extends Controller
{

    public function index(){
        return view('admin.lott.lottEntry');
    }


    public function save(Request $request){
        $wallEntry = new Lott();
        $wallEntry -> desct = $request->desc;
        
        $wallEntry -> date = $request->date;
        ...
        $wallPic = Lott::find($lastId);
 
        $wallPic->image = $picUrl;
        $wallPic-> save();
 
       return redirect('/lott/manage')->with('message','Амжилттай');
    }
    ...
    public function manage(){
        $user = Lott::all();
        return view('admin.lott.lottManage', ['user'=>$user]);
    }
    ...
    public function edit($id){
        ...
        $loanEdit = Lott::where('id', $id)->first();
        return view('admin.lott.lottEdit', ['loan'=>$loanEdit]);

    }

    public function update(Request $request){

       $lead= Lott::find($request->leadid);
       ...
       return redirect('/lott/manage')->with('message','updated');
    }

 
    
    public function delete($id){
        $loanDelete = Lott::find($id);
        $loanDelete->delete();

        return redirect('/lott/manage')->with('message','deleted');
    }
