...
class SettController extends Controller
{
    ...
    public function index(){
        return view('admin.sett.settEntry');
    }


    public function save(Request $request){
        $wallEntry = new Sett();
        $wallEntry -> descr = $request->descr;
       ...
       return redirect('/sett/manage')->with('message','Амжилттай');
    }
    ...
    public function manage(){
        $user = Sett::all();
        return view('admin.sett.settManage', ['user'=>$user]);
    }
    ...
    public function edit($id){
        ...
        $loanEdit = Sett::where('id', $id)->first();
        return view('admin.sett.settEdit', ['loan'=>$loanEdit]);

    }

    public function update(Request $request){

       $lead= Sett::find($request->settid);
       $lead -> descr = $request->descr;
       $lead -> date = $request->date;
    
       $lead -> save();

       return redirect('/sett/manage')->with('message','updated');
    }
