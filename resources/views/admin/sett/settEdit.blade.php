                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="intro-y col-span-12 lg:col-span-6">
                        ...
                        <div class="intro-y box">
                            ...
                            {!! Form::open(['url' => 'sett/edit', 'method'=>'post', 'role'=>'form', 'files' => true, 'enctype'=>'multipart/form-data' ]) !!}

                            <div id="input" class="p-5">
                                <div class="preview">
                                <input type="hidden" value="{{$loan['id']}}" name="settid">
                                   <div class="mt-3">
                                        <label for="regular-form-3" class="form-label">Тайлбар  <span class="required">*</span>  </label>
                                        <div class="mt-3">
                                        <input id="regular-form-5" type="text" class="form-control" value="{{$loan['descr']}}" placeholder="Price" name="descr" required>
                                    </div>
                                  <div class="mt-3">
                                        <label for="regular-form-3" class="form-label">Огноо  <span class="required">*</span>  </label>
                                        <div class="mt-3">
                                        <input id="regular-form-5" type="text" class="form-control" value="{{$loan['date']}}" placeholder="Price" name="date" required>
                                    </div>
