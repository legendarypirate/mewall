                        ...
                        <table class="table table-report -mt-2">
                            <thead>
                                <tr>
                                    ...
                                    <th class="whitespace-no-wrap">Slider</th>
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td>
                                        ...
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center text-theme-6" href="{{url('/slider/delete/'.$singleUser->id)}}" data-toggle="modal" data-target="#delete-confirmation-modal"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Устгах </a>
                                        </div>
                                    </td>
                                </tr>
                               @endforeach
