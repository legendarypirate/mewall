                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="intro-y col-span-12 lg:col-span-6">
                        ...
                        <div class="intro-y box">
                            ...
                            {!! Form::open(['url' => 'quarter/edit', 'method'=>'post', 'role'=>'form', 'files' => true, 'enctype'=>'multipart/form-data' ]) !!}

                            <div id="input" class="p-5">
                                <div class="preview">
                                <input type="hidden" value="{{$quart['id']}}" name="qid">
                                   <div class="mt-3">
                                        <label for="regular-form-3" class="form-label">Улирал  <span class="required">*</span>  </label>
                                        <div class="mt-3">
                                        <input id="regular-form-5" type="text" class="form-control" value="{{$quart['quart']}}" placeholder="Price" name="quarter" required>
                                    </div>
                                      <div class="mt-3">
                                        <label for="regular-form-3" class="form-label">Sar  <span class="required">*</span>  </label>
                                        <div class="mt-3">
                                        <input id="regular-form-5" type="text" class="form-control" value="{{$quart['sar']}}" placeholder="Price" name="sar" required>
                                    </div>
