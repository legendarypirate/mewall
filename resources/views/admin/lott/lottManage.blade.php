...
Lott тохируулах                </h2>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
                        <button class="button text-white bg-theme-1 shadow-md mr-2"><a href="save">Add Lott</a></button>
                        <div class="dropdown">
                        ...
                        <table class="table table-report -mt-2">
                            <thead>
                                <tr>
                                    ...
                                    <th class="whitespace-no-wrap">Lott</th>
                                    <th class="whitespace-no-wrap">Тайлбар</th>
                                                                <th class="whitespace-no-wrap">Өдөр</th>
                            ...
                            @foreach($user as $singleUser)
                                <tr class="intro-x">
                                    <td class="w-40">{{++$i}}</td>
                                    <td>
                                        <a href="" class="font-medium whitespace-no-wrap"><img src="{{asset($singleUser->image)}}" width="60"  alt="no pic"></a>

                                    </td>
                                    <td class="text-center">{{$singleUser->desc}}</td>
                                    <td class="text-center">{{$singleUser->date}}</td>


                                                                        <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3" href="{{url('/lott/edit/'.$singleUser->id)}}"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Засах </a>
                                            <a class="flex items-center text-theme-6" href="{{url('/lott/delete/'.$singleUser->id)}}" data-toggle="modal" data-target="#delete-confirmation-modal"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Устгах </a>
                                        </div>
                                    </td>
                                </tr>
                               @endforeach
