...
Wallpaper тохируулах                </h2>

                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
                        <button class="button text-white bg-theme-1 shadow-md mr-2"><a href="save">Add New wall</a></button>
                        <div class="dropdown">
                        ...
                        <table class="table table-report -mt-2">
                            <thead>
                                <tr>
                                    ...
                                    <th class="whitespace-no-wrap">Wall</th>
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td class="text-center">{{$singleUser->desc}}</td>
                                        ...
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3" href="{{url('/user/edit/'.$singleUser->id)}}"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Засах </a>
                                            <a class="flex items-center text-theme-6" href="{{url('/wall/delete/'.$singleUser->id)}}" data-toggle="modal" data-target="#delete-confirmation-modal"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Устгах </a>
                                        </div>
                                    </td>
                                </tr>
                               @endforeach
