                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="intro-y col-span-12 lg:col-span-6">
                        ...
                        <div class="intro-y box">
                            ...
                            {!! Form::open(['url' => 'price/save', 'method'=>'post', 'role'=>'form', 'files' => true, 'enctype'=>'multipart/form-data' ]) !!}

                            <div id="input" class="p-5">
                                <div class="preview">
                                   <div class="mt-3">
                                        <label for="regular-form-3" class="form-label">Үнэ  <span class="required">*</span>  </label>
                                        <div class="mt-3">
                                        <input id="regular-form-5" type="text" class="form-control" placeholder="Үнэ" name="price" required>
                                    </div>
