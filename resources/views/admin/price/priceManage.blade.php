                        ...
                        <table class="table table-report -mt-2">
                            <thead>
                                <tr>
                                    ...
                                    <th class="whitespace-no-wrap center">Үнэ</th>
                            ...
                            @foreach($user as $singleUser)
                                <tr class="intro-x">
                                    ...
                                    <td >{{$singleUser->price}}</td>


                                                                        <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3" href="{{url('/price/edit/'.$singleUser->id)}}"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Засах </a>
                                        </div>
                                    </td>
                                </tr>
                               @endforeach
